              ...
              <div>
                ...
                <div className="space-y-8 mb-12">
                  {contactInfo.map((item, index) => (
                    <ScrollReveal key={item.title} animation="fade-up" delay={0.15} stagger={0.1} index={index}>
        ...
        <div className="container-luxury text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto text-left">
            {[
              ...
              <ScrollReveal key={faq.q} animation="fade-up" delay={0.1} stagger={0.1} index={index}>
                <div className="bg-card p-6 rounded-lg border border-border/50 h-full">
